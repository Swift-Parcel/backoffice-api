...
namespace SwiftParcel.Infrastructure.Migrations
{
    ...
    [Migration("20260810150107_FixCaseNoteHandlerNavProp")]
    partial class FixCaseNoteHandlerNavProp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SwiftParcel.Domain.Entities.Parcel", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "SenderAddress", "SwiftParcel.Domain.Entities.Parcel.SenderAddress#Address", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("SwiftParcel.Domain.Entities.CaseNote", b =>
                {
                    ...
                    b.HasOne("SwiftParcel.Domain.Entities.Handler", "Handler")
                        ...
                        .HasForeignKey("HandlerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_case_notes_handlers_handler_id");
