...
public class Handler
{
    ...
    public Handler(int userId, string department, DateTime hireDate, int maxCases)
    {
        UserId = userId;
    ...
    public Handler(int id,int userId, string department, DateTime hireDate, int maxCases)
    {
        Id = id;
        UserId = userId;
        Department = department;
